...
return [
    ...
    'password'             => [
        ...
        'uncompromised' => 'Kolom :attribute yang diberikan pernah bocor dalam kebocoran data. Silakan pilih :attribute yang berbeda.',
    ],
    ...
    'required_without_all' => 'Kolom :attribute wajib diisi ketika :values tidak ada.',
    ...
    'attributes' => [
        ...
        'equipment_items.*.equipment_id' => 'peralatan',
        'equipment_items.*.quantity'     => 'jumlah peralatan',
        'loan_date'         => 'tanggal pinjam',
        'due_date'          => 'tanggal kembali',
        'quantity'          => 'jumlah',
        'quantity_total'    => 'total stok',
